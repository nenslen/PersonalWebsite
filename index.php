	...
	<div class='wrapper'>
		...
		<div class='main-content' id='about'>
			...
			<div class='about-content'>
				<img src='images/self-image.jpg' height='200px' width='200' />
			</div>
			<div class='about-content'>
		...
		<div class='main-content' id='education'>
			...
			<div class='education-content'>
				<!--<img src='images/college-icon.png' width='128px' height='128px' />-->
				<h3 class='education-header'>Lethbridge College</h3>
				<p>Diploma in Computer Information Technology (2016)</p>
			</div>
			<div class='education-content'>
				<!--<img src='images/university-icon.png' width='128px' height='128px' />-->
